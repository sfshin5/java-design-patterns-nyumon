package com.sfshin5.javadesignpatterns.no07_Builder.practice_2;
...
public class HTMLBuilder extends Builder {
    ...
    public void buildTitle(String title) { //タイトル作成
    ...
    public void buildString(String str) { //文字列作成
        writer.println("<p>" + str + "</p>"); //段落<p>として出力
    }
    public void buildItems(String[] items) { //箇条書き作成
